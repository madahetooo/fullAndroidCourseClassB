...
import kotlinx.android.synthetic.main.activity_clothes_app.*
...
class ClothesApp : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ivClothesImage.setOnClickListener {
    ...
    private fun downloadImageFromStorage(fileName: String) {
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                withContext(Dispatchers.Main) {
                    ivClothesImage.setImageBitmap(imageBitMap)
                    Toast.makeText(
                        this@ClothesApp,
